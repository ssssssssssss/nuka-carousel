...
var Carousel = (0, _createReactClass2.default)({
  ...
  formatChildren: function formatChildren(children) {
    var self = this;
    var positionValue = this.props.vertical ? Math.round(this.getTweeningValue('top')) : Math.round(this.getTweeningValue('left'));
  ...
  getListStyles: function getListStyles() {
    ...
    var transform = this.getTranslate('' + Math.round(this.getTweeningValue('left')) + 'px, ' + Math.round(this.getTweeningValue('top')) + 'px');
    return {
      transform: transform,
      WebkitTransform: transform,
      msTransform: 'translate(' + Math.round(this.getTweeningValue('left')) + 'px, ' + Math.round(this.getTweeningValue('top')) + 'px)',
      position: 'relative',
      display: 'block',
